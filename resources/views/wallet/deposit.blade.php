...
@section('title', 'Dépôt - LinPay')

@section('content')
<div class="p-6 md:p-8 max-w-4xl mx-auto">
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
        <div class="bg-gradient-to-r from-emerald-600 to-teal-600 px-6 py-4">
            <h1 class="text-2xl font-bold text-white">Déposer de l'argent</h1>
            <p class="text-emerald-100 text-sm">Alimentez votre portefeuille LinPay</p>
        </div>
        ...
        <form action="{{ route('wallet.deposit.post') }}" method="POST" class="p-6 space-y-6">
            @csrf
            <div>
            ...
            <div class="flex justify-end gap-4">
                ...
                <button type="submit" class="px-6 py-2 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700">Valider</button>
            </div>
        </form>
    </div>
</div>
